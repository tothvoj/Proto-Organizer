...
<body>
	<center>
		<form:form id="changeOwnerForm" method="post" action="moveTo?deviceID=${helper.selectedDeviceID}" commandName="helper" style="min-width:500px; min-height:120px; overflow: hidden; padding-top: 30px;">
